...
function online_shop_scripts() {
    ...
    wp_enqueue_style( 'online-shop-style', get_stylesheet_uri() );
    ...
    wp_enqueue_script('online-shop-custom', get_template_directory_uri() . '/assets/js/custom.js', array('jquery'), '1.0.4', 1);
